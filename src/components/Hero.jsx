      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* ⭐ NEW – View All Dealerships Button */}
            <div className="mt-4">
              <Link
                to="/dealer-directory"
                className="group flex items-center justify-center w-full sm:w-auto bg-white/10 hover:bg-white/20 border border-white/20 px-8 py-4 rounded-xl font-semibold backdrop-blur-md transition-all duration-300 hover:scale-105 shadow-lg"
              >
          ...
          {/* RIGHT SIDE FEATURED DEALS CARD */}
